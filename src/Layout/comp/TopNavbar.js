                      ...
                      <li class="icon">
                          <Link href="#">
                            <div class="notification_div">
                              <svg onClick={handleNotificationClick} width="48" height="48" viewBox="0 0 61 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class={!isNotificationOpen ? "notification_popup" : "notification_popup close"}>
                              </div>
                            </div>
                          </Link>
                      </li>
